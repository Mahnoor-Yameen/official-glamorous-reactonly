        ...
        <>
            <div style={{ backgroundColor: "#caf0f8" }}>
                ...
                <div className='container'>
                    ...
                    <a href="#2" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>LOCS Services</a>
                    <a href="#3" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>Kids | Teens</a>
                    <a href="#4" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>Men | Boys</a>
                    <a href="#5" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>EVERY DAY SERVICES - WOMEN</a>
                    <a href="#6" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>BUNDLE OF SERVICES - WOMEN</a>
                    <a href="#7" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>MIXED 'TRENDY' HAIRSTYLES - WOMEN</a>
                    <a href="#8" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>PONYTAILS - WOMEN</a>
                    <a href="#9" className='text-decoration-none  mx-3  btn  p-3 m-1 mt-3 bg-warning ' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>CORNROWS/CAINROWS - WOMEN</a>
                    <a href="#10" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>PIXIE STYLING - WOMEN</a>
                    <a href="#11" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>WIGS - WOMEN</a>
                    <a href="#12" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>WEAVES - WOMEN</a>
                    <a href="#13" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>BRAIDS - WOMEN</a>
                    <a href="#14" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>CROCHET BRAIDS - WOMEN</a>
                    <a href="#15" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>HAIR SERVICES FOR LUXURY EXTENSIONS</a>
                    <a href="#16" className='text-decoration-none  mx-3   btn  p-3 m-1 mt-3 bg-warning' style={{ borderRadius: "15px", fontWeight: "bold", fontSize: "17px" }}>Others</a>
