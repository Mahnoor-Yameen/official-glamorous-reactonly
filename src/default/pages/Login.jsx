...
const Login = () => {
    ...
    console.log(account_state.email,"after user email")
    ...
    return (
        ...
        <div>
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center" style={{backgroundColor:""}}>
