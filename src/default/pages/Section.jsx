        ...
        <>
            <div style={{ backgroundColor: "" }}>
                ...
                <div className='container w-100 row d-flex justify-content-center'>
                    ...
                    <a href="#11" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Facials</a>
                    <a href="#12" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Waxing</a>
                    <a href="#2" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Aesthetic Treatments</a>
                    <a href="#3" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Nail Manicurist</a>
                    <a href="#4" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Natural & Extensions Hair Services</a>
                    <a href="#5" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Makeup</a>
                    <a href="#6" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Lash Extension</a>
                    <a href="#7" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>lash infill</a>
                    <a href="#8" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>classes</a>
                    <a href="#9" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Eyebrow</a>
                    <a href="#10" className='text-decoration-none  mx-3  overflow-hidden col-4 col-sm-5 col-md-3 col-lg-2  my-2   p-3      service-hover ' style={{ fontWeight: "bold", fontSize: "17px" }}>Home Services</a>
